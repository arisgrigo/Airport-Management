...
clean:
	rm -f myprog AirportManagement.o Evretirio.o TSDDA.o TSEvr.o ./BST/ch8_BSTpointerR.o ./AVL/ch8_AVLpointer.o ./DATA/Linux/OUTPUTRandomBST.txt
